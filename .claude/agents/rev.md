...
```bash
python3 $MACHINE_ROOT/tools/decision_tree.py next --agent rev --trigger <trigger_name>
# Triggers: solver_fallback, unpack_failure, custom_vm, z3_unsat

python3 $MACHINE_ROOT/tools/decision_tree.py record --agent rev --trigger <trigger> --action-id <id>
```
